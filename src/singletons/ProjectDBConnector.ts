...
export class ProjectDBConnector {
  ...
  private _activeLoadItemHandler?: (hash: Hash) => void;
  ...
  private _onEventLoadProjectItems = (data: Hash): void => {
    if (this._activeLoadItemHandler) {
      this._activeLoadItemHandler(data);
    }
  };
  ...
  listScenes(
    ...
    this._activeLoadItemHandler = this._onLoadItemsHash;
  ...
  _onLoadItemsHash = (data: Hash): void => {
    ...
    if (this._pendingLoadItems === 0 || this._loadItemsErr !== undefined) {
      ...
      this._activeLoadItemHandler = undefined;
    }
  };
  ...
  getScene(
    ...
    this._activeLoadItemHandler = this.#_onLoadSceneHash;
